...
Each.prototype._run = function() {
  ...
  while ((this._parallel === true ? (this.total * this.options.times - this.started) > 0 : Math.min(this._parallel - this.started + this.done, this.total * this.options.times - this.started))) {
    if (this._errors.length !== 0) {
      break;
    }
    if (this._close) {
