...
Each.prototype._call_next_then = function(error, count) {
  ...
  if (error) {
    while ((ref = (ref1 = this._listeners[0]) != null ? ref1[0] : void 0) !== 'error' && ref !== 'then' && ref !== 'promise') {
  ...
  if (((ref6 = this._listeners[0]) != null ? ref6[0] : void 0) === 'then') {
  ...
  if (((ref7 = this._listeners[0]) != null ? ref7[0] : void 0) === 'promise') {
    if (error) {
